...
# GCC 15 (and never) uses C23 standard, in which keywords false, true oraz bool are reserved
# force gnu17
RUN cd /tmp/source/numdiff-5.9.0 && CFLAGS+=-std=gnu17 ./configure && make && make install
