...
RUN zypper in --no-recommends --no-confirm make gcc11-c++ gcc11-fortran clang12 libboost_headers1_75_0-devel libboost_test1_75_0-devel gsl-devel eigen3-devel sqlite3-devel
